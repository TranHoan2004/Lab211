...
public class Controller {
    ...
    public String calculateEquation() throws Exception {
        ...
        if (a == 0) {
            throw new Exception("The number is divided can not equal to 0");
        }
    ...
    public String calculateQuadraticEquation() throws Exception {
        ...
        if (manager.solveQuadraticEquation(a, b, c) == null) {
